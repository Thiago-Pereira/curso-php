...
<div class="titulo">Incluir Registro #02</div>
...
if(count($_POST) > 0) {
    ...
    if(!filter_var($dados['salario'], FILTER_VALIDATE_FLOAT, $salarioConfig) && $dados['salario'] == "") {
...
<?php foreach($erros as $erro): ?>
    <div class="alert alert-danger" role="alert">
        <?= "Existe um problema no seu formulário" ?>
    </div>
<?php endforeach ?>
